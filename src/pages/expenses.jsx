...
const Expense = () => {
  ...
  useEffect(() => {
    dispatch(applyFilters("EXPENSES"));
  }, [expenseFilters]);

  const handleSortByAmount = (isChecked) => {
    dispatch(sortDataByAmount("EXPENSES", isChecked));
  };

  const handleFilterByCategory = (category) => {
    dispatch(filterDataByCategory("EXPENSES", category));
  };

  const handleAddExpense = (expenseData) => {
    dispatch(addEntry("expenses", expenseData));
  };
