  ...
  switch (type) {
    ...
    case SORT_FILTER_ACTIONS.EXPENSES: {
      ...
      if (sort && category !== "All") {
        ...
        filteredAllExpenses = [...state.expenses].filter(
          (data) => data.category === category,
        );
      } else if (sort && category !== "All") {
        filteredAllExpenses = [...state.expenses].sort(
    ...
    case SORT_FILTER_ACTIONS.SAVING: {
      ...
      if (sort && category !== "All") {
        ...
        filteredAllSaving = [...state.saving].filter(
          (data) => data.category === category,
        );
      } else if (sort && category !== "All") {
        filteredAllSaving = [...state.saving].sort(
          (a, b) => a.amount - b.amount,
        );
      } else {
        filteredAllSaving = state.saving;
